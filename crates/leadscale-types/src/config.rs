//! configuration types for leadscale
...
/// main configuration for leadscale
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            noise_private_key_path: PathBuf::from("/var/lib/leadscale/noise_private.key"),
            prefix_v4: Some("100.64.0.0/10".parse().unwrap()),
            prefix_v6: Some("fd7a:115c:a1e0::/48".parse().unwrap()),
            base_domain: "leadscale.net".to_string(),
...
impl Default for DatabaseConfig {
    fn default() -> Self {
        Self {
            ...
            connection_string: "/var/lib/leadscale/db.sqlite".to_string(),
        }
    }
}
...
impl Default for EmbeddedDerpConfig {
    fn default() -> Self {
        Self {
            enabled: false,
            region_id: 999,
            region_name: "leadscale".to_string(),
